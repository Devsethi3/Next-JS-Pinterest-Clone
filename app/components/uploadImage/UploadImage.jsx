      ...
      <div className="flex items-center bg-gray-100 justify-center w-full rounded-md">
        <div className="w-full p-8 round">
          <label
            ...
            className="flex flex-col items-center justify-center w-full h-[350px] border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-100  hover:bg-gray-50"
          >
            {!selectedFile ? (
